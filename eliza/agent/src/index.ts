...
import { auracoinCharacter } from "./auracoinCharacter.ts";
...
export async function loadCharacters(
    ...
    if (loadedCharacters.length === 0) {
        elizaLogger.info("No characters found, using Auracoin character");
        loadedCharacters.push(auracoinCharacter);
    }
...
const startAgents = async () => {
    ...
    let characters = [auracoinCharacter];
